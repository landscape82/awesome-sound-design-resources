...
> A curated list of awesome - mostly open source - resources and tools for sound design, audio production, and music creation.
...
- [Awesome Sound Design resources ](#awesome-sound-design-resources-)
  ...
  - [Synthesizers](#synthesizers)
    ...
    - [Modular Synthesizers](#modular-synthesizers)
  - [Samplers \& Sample Manipulation](#samplers--sample-manipulation)
  - [Effects \& Processing](#effects--processing)
    - [Multi-Effects Suites](#multi-effects-suites)
  ...
  - [Niche \& Specialized Tools](#niche--specialized-tools)
    ...
    - [Voice \& Speech Processing](#voice--speech-processing)
    - [Bioacoustics \& Scientific Audio](#bioacoustics--scientific-audio)
    - [Game Audio \& Interactive Sound](#game-audio--interactive-sound)
  - [Experimental \& Research](#experimental--research)
    ...
    - [Unconventional Interfaces](#unconventional-interfaces)
...
- **[Dexed](https://asb2m10.github.io/dexed/)** - FM synthesizer inspired by Yamaha DX7.
- **[Helm](https://tytel.org/helm/)** - Polyphonic synthesizer with modern interface and extensive modulation.
- **[Surge](https://surge-synthesizer.github.io/)** - Hybrid synthesizer with subtractive, wavetable, and FM synthesis.
...
- **[SoX](http://sox.sourceforge.net/)** - Command-line audio processing toolkit for format conversion and effects.
...
- **[TidalCycles](https://tidalcycles.org/)** - Live coding environment for algorithmic patterns.
...
- **[Audiotool](https://www.audiotool.com/)** - Browser-based music production studio with modular interface.
...
- **[FMOD Studio](https://www.fmod.com/)** - Audio content creation tool for games (free for indie developers).
...
- **[Wwise](https://www.audiokinetic.com/products/wwise/)** - Audio engine for interactive media (free for educational use).
...
- **[PsySound](https://github.com/densilcabrera/psysound3)** - Psychoacoustic analysis software.
- **[THD+N Analyzer](https://github.com/righthalfplane/THD)** - Total harmonic distortion and noise analysis.

### Live Coding & Network Music
- **[Fluxus](http://www.pawfal.org/fluxus/)** - Rapid prototyping and playing for 3D audio-visual content.
...
- **[AudioLazy](https://github.com/danilobellini/audiolazy)** - Real-time audio processing Python library with focus on laziness.
